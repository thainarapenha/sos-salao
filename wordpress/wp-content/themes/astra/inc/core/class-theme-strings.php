	...
	function astra_default_strings( $key, $echo = true ) {
		...
		$defaults = apply_filters(
			...
			array(
				...
				'string-comment-title-reply'             => __( 'Deixe seu comentário', 'astra' ),
				'string-comment-cancel-reply-link'       => __( 'Cancel Reply', 'astra' ),
				'string-comment-label-submit'            => __( 'Postar Comentário &raquo;', 'astra' ),
				'string-comment-label-message'           => __( 'Digite aqui..', 'astra' ),
				...
				'string-blog-meta-leave-a-comment'       => __( 'Deixe seu comentário', 'astra' ),
